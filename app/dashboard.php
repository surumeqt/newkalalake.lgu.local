    ...
    <div class="dashboard-bottom-grid">
        ...
        <div class="quick-actions-announcements-container">
            ...
            <div class="quick-actions-list">
                <a href="./case-entry.php" data-load-content="true" url="./case-entry.php"
                ...
                <a href="./upload.php" data-load-content="true" url="./upload.php"
                ...
                <a href="./database-page.php" data-load-content="true" class="action-button secondary-button">
                    <svg xmlns="http://www.w3.org/2000/svg" class="button-icon" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z" />
                        <path fill-rule="evenodd"
                            d="M18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 110-2h1a1 1 0 110 2H4zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z"
                            clip-rule="evenodd" />
                    </svg>
                    Browse Database
                </a>
